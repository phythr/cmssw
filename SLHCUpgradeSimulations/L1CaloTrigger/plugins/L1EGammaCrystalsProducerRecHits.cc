...
// Class: L1EGammaCrystalsProducerRecHits
//
/**\class L1EGammaCrystalsProducerRecHits L1EGammaCrystalsProducerRecHits.cc SLHCUpgradeSimulations/L1CaloTrigger/plugin/L1EGammaCrystalsProducerRecHits.cc
...
class L1EGammaCrystalsProducerRecHits : public edm::EDProducer {
   public:
      explicit L1EGammaCrystalsProducerRecHits(const edm::ParameterSet&);
...
L1EGammaCrystalsProducerRecHits::L1EGammaCrystalsProducerRecHits(const edm::ParameterSet& iConfig) :
...
void L1EGammaCrystalsProducerRecHits::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
bool
L1EGammaCrystalsProducerRecHits::cluster_passes_cuts(const l1slhc::L1EGCrystalCluster& cluster) const {
   //return true;
...
DEFINE_FWK_MODULE(L1EGammaCrystalsProducerRecHits);
